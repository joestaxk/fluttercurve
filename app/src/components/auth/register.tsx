        ...
        <div className="">
          ...
          <form method="POST" onSubmit={handleRegister} className='mt-10'>
            ...
            <div className={`bg-[#f4f4f4] md:text-lg text-sm rounded-md transition-all duration-300 ${validation.fullname.status ? 'border-[1px] border-[red]' : ''}`}>
              <input  className='bg-transparent font-medium text-[#526288] w-full p-3 border-0 outline-none lowercase' name="fullname" type="text" placeholder="Your Fullname *" required/>
            </div>

            <div className='bg-[#f4f4f4] rounded-md mt-3 md:text-lg text-sm'>
              <input  className='bg-transparent font-medium text-[#526288] w-full p-3 border-0 outline-none lowercase' name='username' pattern="[a-zA-Z]*(\d|[a-zA-Z]){4,8}$" title="4 to 8 lowercase letters" type="text" placeholder="Your Username *" required/>
            </div>
            ...
            <div className='w-full flex gap-2 mt-3 md:text-lg text-sm '>
              <div className='w-1/2 bg-[#f4f4f4] rounded-md relative'>
                <input className='bg-transparent font-medium text-[#526288] w-full p-3 border-0 outline-none' type={viewPwd.pass ? "text" : "password"} name='password' placeholder="Password *" autoComplete='off' required/>
              ...
              <div className={`w-1/2 bg-[#f4f4f4] relative rounded-md transition-all duration-300 ${validation.cpassword.status ? 'border-[1px] border-[red]' : 'border-none'}`}>
                <input  className='bg-transparent font-medium text-[#526288] w-full p-3 border-0 outline-none' type={viewPwd.cpass ? "text" : "password"} name='cpassword' placeholder="Confirm Password *" required/>
                <button type='button' onClick={() => setViewPwd((PREV) => {return {...PREV, cpass: !viewPwd.cpass}} )}  className='appearance-none border-none absolute right-2 top-3'>
