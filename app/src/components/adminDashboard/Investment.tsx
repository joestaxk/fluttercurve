                        ...
                        //     <div className="">
                            ...
                            className="w-[380px] p-3 border-[1px] rounded-lg bg-[#e5e5e530] border-[#ccc] min-h-[350px] flex flex-col">
                                ...
                                <div className="w-full flex flex-col gap-2 justify-center mt-8 text-[#eee] font-bold">
                                    {data.status == "NEW" && <Link target="_blank" href={`https://commerce.coinbase.com/charges/${data.chargeID}`} className="px-3 py-2 text-center rounded-xl w-full bg-[#212689b6] transition-all duration-200 hover:bg-[#212689d7]">Complete Payment</Link>}
                                    {/* <button className="px-3 py-2 rounded-xl w-full bg-[#f42525]">Cancel Payment</button> */}
                                    {
                                        ...
                                        <>
                                            ...
                                            <Link href={"/office/dashboard/earnings"} className="px-3 py-2 rounded-xl w-full bg-[#5680c8] text-center">View Earnings</Link>
                                        </> : <></>
                                    }
                                </div>
                        </div> 
