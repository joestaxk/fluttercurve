       ...
       <main className="w-[330px] pr-3 min-h-[100vh]  fixed top-0 left-0">
          <div className="w-full flex flex-col mt-[10rem] gap-4 border-r-[1px] border-r-[#ccc]">
            ...
            <ActiveLink href="/office/admin/account-settings">
              <div className="flex gap-2 text-xl hover:font-medium items-center ">
                  <div className="">
                    <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" viewBox="0 0 48 48"><g fill="#857ea3"><path d="M32 20a8 8 0 1 1-16 0a8 8 0 0 1 16 0Z"/><path fillRule="evenodd" d="M23.184 43.984C12.517 43.556 4 34.772 4 24C4 12.954 12.954 4 24 4s20 8.954 20 20s-8.954 20-20 20a21.253 21.253 0 0 1-.274 0c-.181 0-.362-.006-.542-.016ZM11.166 36.62a3.028 3.028 0 0 1 2.523-4.005c7.796-.863 12.874-.785 20.632.018a2.99 2.99 0 0 1 2.498 4.002A17.942 17.942 0 0 0 42 24c0-9.941-8.059-18-18-18S6 14.059 6 24c0 4.916 1.971 9.373 5.166 12.621Z" clipRule="evenodd"/></g></svg>
                  </div>
            ...
            <ActiveLink href="/office/admin/settings/">
              <div className="flex gap-2 text-xl hover:font-medium items-center ">
                  <div className="">
                    <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" viewBox="0 0 14 14"><g fill="none" stroke="#857ea3" strokeLinecap="round" strokeLinejoin="round"><rect width="13" height="11.5" x=".5" y=".5" rx="1"/><circle cx="8.5" cy="6.25" r="1.75"/><path d="M8.5 3.25V4.5m0 3.5v1.25m3-3h-1.25m-3.5 0H5.5m5.12-2.12l-.88.88M7.26 7.49l-.88.88m4.24 0l-.88-.88M7.26 5.01l-.88-.88M3 4.5V8m-1 4v1.5m9.5-1.5v1.5"/></g></svg>
                  </div>
