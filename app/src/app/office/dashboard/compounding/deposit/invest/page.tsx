          ...
          <div className="mt-4">
            <h1 className="text-4xl text-white font-medium">Compounding Investment</h1>
             <div className="flex items-center mt-3">
               <h2 className="text-2xl text-[#e0e0e0] font-light"><Link href="/office/dashboard/compounding">Home</Link></h2>
              ...
              <h2 className="text-2xl text-[#e0e0e0] font-light">Compounding Investment</h2>
             </div>
          </div>
        </Dashboard>
