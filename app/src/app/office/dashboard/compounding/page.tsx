    ...
    return (
      <main>
        <Dashboard state={state}>
          <div className="mt-4">
            <h1 className="text-4xl text-white font-medium">Compounding Mode</h1>
             <div className="flex items-center mt-3">
              ...
              <h2 className="text-2xl text-[#e0e0e0] font-light">Welcome</h2>
             </div>

             <div className="flex gap-3 mt-3">
              <div className="w-[200px] flex bg-slate-100 hover:bg-slate-200 transition-all duration-200 rounded-md ">
                <Link href={"/office/dashboard/compounding/deposit/invest"} className="p-4 w-full">Make Investment</Link>
              </div>

              <div className="w-[200px] bg-slate-100 flex hover:bg-slate-200 transition-all duration-200  rounded-md">
                <Link href={"/office/dashboard/compounding/deposit"} className="p-4 w-full">View Investment</Link>
              </div>
             </div>
          </div>
        </Dashboard>
