          ...
          <div className={`bg-white ${state?.referral  ? "lg:w-[70%] w-full" : "w-[90%]"}  shadow rounded-lg min-h-[150px] p-4 flex items-center justify-between`}>
            <div className="">
                ...
                <div className="">
                  ...
                  <Link href={"/office/dashboard/profile"} className="w-fit flex items-center bg-[#393fff] p-3 mt-3 gap-2 transition hover:shadow-2xl shadow-[#212121dd] duration-200 text-white rounded-md">
