    ...
    return (
      <main>
        <Dashboard state={state}>
          <div className="mt-4">
            <h1 className="text-3xl n:text-4xl text-white font-medium">Compounding Deposits</h1>
             <div className="flex items-center mt-3">
               <h2 className="text-xl n:text-2xl  text-[#ccc] font-medium">
              ...
              <h2 className="text-xl n:text-2xl  text-[#ccc] font-medium">Compounding Deposits</h2>
             </div>
          </div>
        </Dashboard>
