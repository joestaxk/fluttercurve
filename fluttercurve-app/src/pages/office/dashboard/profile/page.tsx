        ...
        <div className="bg-white md:w-[65%] w-full shadow rounded-lg min-h-[150px] md:p-4 p-1 flex items-center md:gap-0 gap-4 justify-between">
          ...
          <div className="">
            <div className="">
              ...
              {/* <Link target="_blank" href={`${MAIN_APP_URL}/register?ref=${state.userName}`}  className="text-[#373737] border-b-2 border-dotted border-[#31313187] hover:border-[#31313]">{MAIN_APP_URL}/register?ref={state.userName}</Link> */}
