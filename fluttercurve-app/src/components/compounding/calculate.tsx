...
export default function CalculateCompoundingInvestmentPlan({state, compoundingPlans}:{state: userDataStateType, compoundingPlans: compoundPlanType<string>}) {
    ...
    const container = {
      ...
      function handleCalculation(ev:any){
        ev.preventDefault();
        let val = ev.target;
        const data = {
                ...
                <form method="POST" onSubmit={handleCalculation}>
                    ...
                    <div className="mt-3">
                        ...
                        <div className={`${validate.duration ? "text-[#d62c2c] border-[#d62c2c]": "border-[#ccc] focus-within:border-[#4385ff]"} transition-all duration-300  border-[1px] w-full flex`}>
                            <div className="w-[80%] ">
                                <input type="number" defaultValue={compoundingPlans?.duration} name="compoundingPeriod" className="w-full p-4 outline-none" placeholder="0.0"/>
                            </div>
                    ...
                    <div className="flex justify-between mt-3">
                        <button type="submit" name="calculate" className="bg-[#3939ff] flex items-center p-3 gap-2  text-white font-semi-bold rounded-md">
                        ...
                        <button type="button" name="continue" className="bg-[#0e802c] flex items-center p-3 gap-2 text-white font-semi-bold rounded-md">
                            <span>Continue</span>
