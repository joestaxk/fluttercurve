  ...
  return (
    <>
      <svg
        ...
        className="fixed top-0 z-[51] block xl:hidden cursor-pointer right-2"
      ...
      >
        ...
        <div
          className="w-full flex flex-col border-r-[1px] xl:border-r-[#ccc] overflow-y-auto"
        ...
        >
            ...
            <div className="flex gap-2 xxl:text-xl text-lg hover:font-medium items-center ">
              <div className="">
                ...
                >
                  <path
                    fill="#514AB1"
                    d="M1408 512h512v512h-128V731l-576 575l-256-256l-704 705v37h1664v128H128V128h128v1445l704-703l256 256l485-486h-293V512z"
                  />
                </svg>
              </div>
          ...
          <ActiveLink href="/office/dashboard/transactions">
            <div className="flex gap-2 xxl:text-xl text-lg hover:font-medium items-center ">
              <div className="">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  ...
                  viewBox="0 0 64 64"
                >
                  <g fill="none" stroke="#514AB1" stroke-width="2">
                    <circle cx="32" cy="32" r="30" fill="none" />
                    <line x1="15" y1="32" x2="49" y2="32" />
                    <line x1="32" y1="15" x2="32" y2="49" />
                    <path d="M41.66 25.34L32 35l-9.66-9.66a2 2 0 0 1 2.83-2.83L32 29l7.83-7.83a2 2 0 0 1 2.83 2.83z" />
                  </g>
                </svg>
              </div>
            ...
            <div className="flex gap-2 xxl:text-xl text-lg hover:font-medium items-center ">
              <div className="">
                ...
                >
                  ...
                  >
                    <rect width="13" height="11.5" x=".5" y=".5" rx="1" />
                    <circle cx="8.5" cy="6.25" r="1.75" />
                    <path d="M8.5 3.25V4.5m0 3.5v1.25m3-3h-1.25m-3.5 0H5.5m5.12-2.12l-.88.88M7.26 7.49l-.88.88m4.24 0l-.88-.88M7.26 5.01l-.88-.88M3 4.5V8m-1 4v1.5m9.5-1.5v1.5" />
                  </g>
                </svg>
              </div>
