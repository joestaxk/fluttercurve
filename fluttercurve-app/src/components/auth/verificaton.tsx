    ...
    <>
      {
        <main className="min-h-[100vh] w-full">
              {!cookies['xat'] ? <div className="flex justify-center"><Pageloader /></div>: <div className="w-full h-[60vh] flex justify-center items-center">
                  <div className='md:w-[400px] border-[#ccc] border-[1px] w-full min-h-auto rounded-xl md:p-8 p-4 bg-white'>
                    <div className="flex justify-center">
                        <div className="flex justify-center flex-col items-center">
                          ...
                          <h2 className="font-semibold text-[#1f3446d9]">Account has been verified successfully</h2>
